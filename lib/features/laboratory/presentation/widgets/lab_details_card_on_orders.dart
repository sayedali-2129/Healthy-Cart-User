...
class LabDetailsCardOnOrders extends StatelessWidget {
  const LabDetailsCardOnOrders({
    super.key,
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              labData.laboratoryName ?? 'Unknown Pharmacy',
                  ...
                  child: SizedBox(
                    child: Column(
                      ...
                      children: [
                        RowTwoTextWidget(
                            text1: 'Address :',
                            text2: labData.address ?? 'Unknown Address',
                            gap: 8),
                        const Gap(4),
                        RowTwoTextWidget(
                            text1: 'Phone No :',

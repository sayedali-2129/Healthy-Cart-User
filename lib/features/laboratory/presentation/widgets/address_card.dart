              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                            ...
                            Text(
                              addressProvider.selectedAddress == null
                                  ? addressProvider
                                      ...
                                      'User'
                                  : addressProvider.selectedAddress!.name ??
                                      'User',
                              maxLines: 2,
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    addressProvider.selectedAddress == null
                                        ? addressProvider.userAddressList.first
                                                .addressType ??
                                            'Home'
                                        : addressProvider
                    ...
                    Text(
                      addressProvider.selectedAddress == null
                          ? addressProvider.userAddressList.first.phoneNumber ??
                              'Address'
                          : addressProvider.selectedAddress!.phoneNumber ??
                              '0000000000',

...
class HospitalCategoriesScreen extends StatefulWidget {
  const HospitalCategoriesScreen({
    super.key,
  ...
  @override
  State<HospitalCategoriesScreen> createState() => _HospitalCategoriesScreenState();
}

class _HospitalCategoriesScreenState extends State<HospitalCategoriesScreen> {
  @override

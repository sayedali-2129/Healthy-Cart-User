...
import '../../features/authentication/application/provider/authenication_provider.dart'
    as _i34;
import '../../features/authentication/domain/facade/i_auth_facade.dart' as _i26;
import '../../features/authentication/infrastructure/i_auth_impl.dart' as _i27;
import '../../features/home/application/provider/home_provider.dart' as _i33;
import '../../features/home/domain/facade/i_home_facade.dart' as _i23;
import '../../features/home/infrastructure/i_home_impl.dart' as _i24;
...
import 'general_injectable_module.dart' as _i37;
...
Future<_i1.GetIt> init(
  ...
  gh.lazySingleton<_i23.IHomeFacade>(
      () => _i24.IHomeImpl(gh<_i6.FirebaseFirestore>()));
  gh.factory<_i25.LocationProvider>(
      () => _i25.LocationProvider(gh<_i15.ILocationFacade>()));
  gh.lazySingleton<_i26.IAuthFacade>(() => _i27.IAuthImpl(
        gh<_i4.FirebaseAuth>(),
        gh<_i6.FirebaseFirestore>(),
      ));
  gh.factory<_i28.LabOrdersProvider>(
      () => _i28.LabOrdersProvider(gh<_i19.ILabOrdersFacade>()));
  gh.lazySingleton<_i29.IUserProfileFacade>(() => _i30.IUserProfileImpl(
        gh<_i6.FirebaseFirestore>(),
        gh<_i7.ImageService>(),
      ));
  gh.factory<_i31.LabProvider>(() => _i31.LabProvider(
        gh<_i17.ILabFacade>(),
        gh<_i19.ILabOrdersFacade>(),
      ));
  gh.factory<_i32.HospitalProvider>(
      () => _i32.HospitalProvider(gh<_i21.IHospitalFacade>()));
  gh.factory<_i33.HomeProvider>(
      () => _i33.HomeProvider(gh<_i23.IHomeFacade>()));
  gh.factory<_i34.AuthenticationProvider>(
      () => _i34.AuthenticationProvider(gh<_i26.IAuthFacade>()));
  gh.factory<_i35.UserAddressProvider>(
      () => _i35.UserAddressProvider(gh<_i29.IUserProfileFacade>()));
  gh.factory<_i36.UserProfileProvider>(
      () => _i36.UserProfileProvider(gh<_i29.IUserProfileFacade>()));
  return getIt;
}

class _$FirebaseInjecatbleModule extends _i3.FirebaseInjecatbleModule {}

class _$GeneralInjecatbleModule extends _i37.GeneralInjecatbleModule {}

...
import 'package:healthy_cart_user/core/services/custom_upgrade_alert.dart';
...
class _BottonNavTabState extends State<BottomNavigationWidget>
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      minAppstoreVersion:
          context.read<GeneralProvider>().generalModel?.minAppstoreVersion ?? '1.0.0',
      minPlaystoreVersion:
          context.read<GeneralProvider>().generalModel?.minPlaystoreVersion ?? '1.0.0',
          child: Scaffold(
            body: PopScope(
              ...
              child: SizedBox(
                ...
                child: TabBar(
                    ...
                    indicator: UnderlineTabIndicator(
                      ...
                      insets: const EdgeInsets.fromLTRB(20.0, 0.0, 20.0, 52.0),
